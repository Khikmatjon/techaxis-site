...
export default async function HomePage({ params }: { params: Promise<{ locale: string }> }) {
  ...
  // BU YERDA: string emas, locale bo'lishi kerak!
      ...
      <section className="py-20 px-4 max-w-7xl mx-auto text-center">
        <div className="p-12 rounded-[40px] bg-slate-900 text-white shadow-2xl overflow-hidden relative border border-slate-800">
          <div className="relative z-10">
            <h2 className="text-3xl md:text-5xl font-bold mb-6 font-display italic uppercase tracking-tighter">
            ...
            <p className="text-slate-400 mb-8 max-w-xl mx-auto text-lg leading-relaxed">
              ...
              <strong> HAYOT</strong> aqlli bilaguzugi va professional muhandislik kurslarimiz bilan tanishing. [cite: 2026-02-25]
            </p>
