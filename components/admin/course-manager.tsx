...
// Kurs mazmunini (kurs / modul / dars) boshqarish paneli.
// /admin sahifasi ichida "Kurslar mazmuni" tab sifatida ishlatiladi.
export default function CourseManager() {
  ...
  return (
    <div>
      ...
      <p className="text-slate-400 mb-6 text-sm">Kurs narxi, modul va darslarni shu yerda tahrirlang — saytda darhol yangilanadi.</p>
