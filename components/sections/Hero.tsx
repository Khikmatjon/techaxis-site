export const Hero = ({ dict }: { dict: any }) => {
  return (
    <section
      id="home"
      className="relative pt-32 pb-20 lg:pt-40 lg:pb-32 overflow-hidden bg-white dark:bg-slate-950"
    >
      <div className="absolute inset-0 z-0 bg-[radial-gradient(ellipse_at_top_right,_var(--tw-gradient-stops))] from-blue-50/50 via-white to-white dark:from-blue-900/20 dark:via-slate-950 dark:to-slate-950" />
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
        ...
        <div className="relative mt-12 lg:mt-0">
          <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[120%] h-[120%] bg-gradient-to-tr from-cyan-100 to-blue-50 dark:from-cyan-900/20 dark:to-blue-900/20 rounded-full blur-3xl opacity-50 z-0" />
            ...
            <div className="absolute bottom-8 right-8 bg-white/90 dark:bg-slate-900/90 backdrop-blur-md p-4 rounded-2xl shadow-xl flex items-center gap-4 border border-slate-100 dark:border-slate-800">
              ...
              <div>
                ...
                <div className="text-xs font-semibold text-emerald-500">
                  {dict?.hero?.expert_badge || "Sertifikatlangan Ekspert"}
                </div>
              </div>
            </div>
          </div>
